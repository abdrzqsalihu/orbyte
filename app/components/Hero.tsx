...
const Hero = () => {
    return (
        <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden border-b">
            ...
            <div className="container relative z-10 px-4 md:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
                {/* Left Content */}
                <div className="flex-1 flex flex-col items-center text-center lg:items-start lg:text-left">
                    ...
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tighter mb-6 text-foreground leading-[1.05]">
                    ...
                    <p className="text-lg text-muted-foreground mb-10 max-w-xl leading-relaxed tracking-tight">
