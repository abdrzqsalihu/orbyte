            ...
            <div className="container px-4 md:px-8 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 border-x border-t border-border">
                    ...
                    <div className="p-8 border-b md:border-r border-border hover:bg-muted/30 transition-colors duration-300 ease-out group">
                        <Columns className="h-5 w-5 mb-6 text-foreground group-hover:text-primary transition-colors" strokeWidth={1.25} />
                        <h3 className="text-lg font-medium mb-2 tracking-tight">Kanban Board</h3>
                    ...
                    <div className="p-8 border-b md:border-r border-border bg-muted/10 hover:bg-muted/30 transition-colors duration-300 ease-out group relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-4 opacity-10">
                            <PieChart strokeWidth={1.15} className="h-32 w-32" />
                        </div>
                        <LayoutDashboard className="h-5 w-5 mb-6 text-foreground group-hover:text-primary transition-colors" strokeWidth={1.25} />
                        <h3 className="text-lg font-medium mb-2 tracking-tight">Overview Dashboard</h3>
                        <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    <div className="p-8 border-b border-border hover:bg-muted/30 transition-colors duration-300 ease-out group">
                        <CheckSquare strokeWidth={1.25} className="h-5 w-5 mb-6 text-foreground group-hover:text-primary transition-colors" />
                        <h3 className="text-lg font-medium mb-2 tracking-tight">Tasks Management</h3>
                        <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    {/* Feature 4 */}
                    <div className="p-8 border-b md:border-r border-border hover:bg-muted/30 transition-colors duration-300 ease-out group">
                        <Calendar strokeWidth={1.25} className="h-5 w-5 mb-6 text-foreground group-hover:text-primary transition-colors" />
                        <h3 className="text-lg font-medium mb-2 tracking-tight">Calendar View</h3>
                        <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    {/* Feature 5 */}
                    <div className="p-8 border-b md:border-r border-border hover:bg-muted/30 transition-colors duration-300 ease-out group">
                        <Download strokeWidth={1.25} className="h-5 w-5 mb-6 text-foreground group-hover:text-primary transition-colors" />
                        <h3 className="text-lg font-medium mb-2 tracking-tight">Export Functionality</h3>
                        <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    {/* Feature 6 */}
                    <div className="p-8 border-b border-border hover:bg-muted/30 transition-colors duration-300 ease-out group">
                        <Palette strokeWidth={1.25} className="h-5 w-5 mb-6 text-foreground group-hover:text-primary transition-colors" />
                        <h3 className="text-lg font-medium mb-2 tracking-tight">Appearance Customization</h3>
                        <p className="text-sm text-muted-foreground leading-relaxed">
