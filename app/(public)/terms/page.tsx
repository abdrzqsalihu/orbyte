            ...
            <div className="mx-auto max-w-3xl space-y-8">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center text-base md:text-lg font-medium">
                        <Zap className="mr-2 h-4 w-4 md:h-5 md:w-5 text-primary" />
                        Orbyte
                    </div>
                </div>

                <div className="space-y-4">
                    <h1 className="text-2xl md:text-4xl font-bold tracking-tight">Terms of Service</h1>
                    <p className="text-sm md:text-base text-muted-foreground">Last updated: March 25, 2026</p>
                </div>
                ...
                <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-sm md:text-base leading-relaxed text-muted-foreground">
                    <section className="space-y-3">
                        <h2 className="text-lg md:text-xl font-semibold text-foreground">1. Acceptance of Terms</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-lg md:text-xl font-semibold text-foreground">2. Use License</h2>
                        <p className="text-sm md:text-base">
                    ...
                    <section className="space-y-3">
                        <h2 className="text-lg md:text-xl font-semibold text-foreground">3. Disclaimer</h2>
                        <p className="text-sm md:text-base">
                    ...
                    <section className="space-y-3">
                        <h2 className="text-lg md:text-xl font-semibold text-foreground">4. Limitations</h2>
                        <p className="text-sm md:text-base">
                    ...
                    <section className="space-y-3">
                        <h2 className="text-lg md:text-xl font-semibold text-foreground">5. Governing Law</h2>
                        <p className="text-sm md:text-base">
