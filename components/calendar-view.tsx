...
export function CalendarView({ tasks }: CalendarViewProps) {
  ...
  return (
    <div className="h-full">
          ...
          return (
            ...
            >
              <div className="w-full flex justify-between items-center mb-1">
                ...
                {hasHighPriority && <span className="h-2 w-2 rounded-full bg-red-500"></span>}
                {!hasHighPriority && hasMediumPriority && <span className="h-2 w-2 rounded-full bg-amber-500"></span>}
              </div>
      ...
      {selectedDate && (
        <div className="mt-6">
          <h3 className="font-medium mb-4 text-muted-foreground">Tasks for {format(selectedDate, "MMMM d, yyyy")}</h3>
